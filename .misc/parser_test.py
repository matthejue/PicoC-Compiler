...
class TestStatementGrammar(unittest.TestCase, UsefullTools):
    def test_semicolon_after_another(self, ):
        tokens = self.set_everything_up_for_ast(
            "semicolon after another", "void main() { ; int x = 12"
            "; ; if (x < 10) { ; }; }")
        self.assertEqual(
...
class TestArithmeticExpressionGrammar(unittest.TestCase, UsefullTools):
    ...
    def test_unary_operators(self):
        self.set_everything_up_for_ast(
            "unary operators", "void main() { var = -12 % (---154 - "
            "--189); }")
    ...
    def test_character_as_operand(self, ):
        self.set_everything_up_for_ast(
            "character as operand", "void main() { int x = 'C' + 1; "
            "x = x + ('a' - 'A'); }")
...
class TestLogicExpressionGrammar(unittest.TestCase, UsefullTools):
    ...
    def test_logic_precedence_1(self, ):
        self.set_everything_up_for_ast(
            "logic precedence 1", "void main() { var = 12 >= dom && 34 <"
            " 4 || a == b; }")
    ...
    def test_logic_precedence_2(self, ):
        self.set_everything_up_for_ast(
            "logic precedence 2", "void main() { var = 12 == dom || c >="
            " 4 || a != b; }")
        expected_res = "('main' ('=' 'var' ('||' ('==' '12' 'dom') "\
            "('||' ('>=' 'c' '4') ('!=' 'a' 'b')))))"
        self.assertEqual(str(self.grammar.reveal_ast()), expected_res)
    ...
    def test_logic_and_arithmetic_parenthesis_mixed(self, ):
        self.set_everything_up_for_ast(
            "logic and arithmetic parenthesis "
            "mixed", "void main() { var = (12 <= (dom - 1) "
            "* 2 || 42 != cars) && cars == 0; }")
        expected_res = "('main' ('=' 'var' ('&&' ('||' ('<=' '12' ('*' "\
...
class TestIfElseGrammar(unittest.TestCase, UsefullTools):
    def test_if_else_grammar(self):
        self.set_everything_up_for_ast(
            "if else grammar", "void main() { if (var >= 0) var = 12; "
            "else var = var + 1; }")
    ...
    def test_if_else_braces(self):
        self.set_everything_up_for_ast(
            "if else braces", "void main() { if (var == 0) { var = "
    ...
    def test_else_if(self, ):
        self.set_everything_up_for_ast(
            "else if", "void main() { if (var == 0) var = 100;"
    ...
    def test_two_if_after_another(self, ):
        self.set_everything_up_for_ast(
            "two if after another", "void main() { if (var == 0) cars = 10;"
            " if (cars == 10) { var = 42; } }")
    ...
    def test_if_arithmetic_expression_as_logical_expression(self, ):
        self.set_everything_up_for_ast(
            "if arithmetic expression as logical "
            "expression", "void main() { if (123 * var) { var = "
            "123; } }")
...
class TestLoopGrammar(unittest.TestCase, UsefullTools):
    def test_while_loop(self, ):
        self.set_everything_up_for_ast(
            "while loop", "void main() { while ( x < 12 ) { x = "
            "x + 1; } }")
    ...
    def test_do_while_loop(self, ):
        self.set_everything_up_for_ast(
            "do while loop", "void main() { do { x = x + 1; } "
            "while ( y < 10 ); }")
    ...
    def test_several_statements_loop(self, ):
        self.set_everything_up_for_ast(
            "several statements loop", "void main() { do { y = x; x = x + 1; "
            "} while ( y < 10 ); }")
    ...
    def test_loop_and_nested_if_else(self, ):
        self.set_everything_up_for_ast(
            "loop and nested if else", "void main() { while (x < 12) { x = x "
            "+ 1; if (x == 42) { y = y + 1; } } }")
    ...
    def test_nested_loops(self, ):
        self.set_everything_up_for_ast(
            "nested loops", "void main() { while (x <= 42) { "
            "while (y <= 42) { z = x * y; } } }")
