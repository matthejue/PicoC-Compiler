...
def loop(self):
    ...
    if self.LTT(1) == TT.WHILE:
        ...
        self.do_while()
    # TODO: eigentlich ergibt hier der Error keinen Sinnn, weil er nie
...
def while_(self):
    ...
    :returns: None
    """
    savestate_node = self.ast_builder.down(ASTNode, [TT.WHILE])
...
def do_while(self):
    ...
    :returns: None
    """
    savestate_node = self.ast_builder.down(ASTNode, [TT.DO_WHILE])
