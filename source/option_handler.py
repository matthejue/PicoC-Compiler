...
from source import symbol_table as st
from source import picoc_nodes as pn
from source import reti_nodes as rn
from source import debug as db
import sys
import shutil
from source.ast_node import ASTNode
from source.ast_transformers import TransformerPicoC, TransformerRetiBlocks
from source.passes import Passes
from source.passes.compilation import opt_level_1
from source.utils.util_funs_dependent import (
    remove_ext,
    throw_error,
    subheading,
    get_ext,
)
from source.utils.util_funs_independent import convert_to_single_line
...
def _print_args_if_verbose():
    from source.global_vars import args  # uses the shared args object
