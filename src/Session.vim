...
set shortmess=aoO
badd +20 ~/Documents/Studium/pico-c-compiler/src/errors.py
badd +25 ~/Documents/Studium/pico-c-compiler/src/ast_builder.py
badd +169 ~/Documents/Studium/pico-c-compiler/src/lexer.py
badd +2 ~/Documents/Studium/pico-c-compiler/src/parser.py
badd +149 ~/Documents/Studium/pico-c-compiler/src/pico_c_compiler.py
...
badd +0 term://~/Documents/Studium/pico-c-compiler//307032:/usr/bin/python
argglobal
%argdel
$argadd errors.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 102 - ((2 * winheight(0) + 22) / 45)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 165 - ((40 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 165
